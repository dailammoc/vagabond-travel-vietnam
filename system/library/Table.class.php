...
class Table
{
	...
	static public function IsUpdate($n, $id, $r=array()) {
		return DB::Update($n, $id, $r);
	}

	static public function FastUpdate($n,$arr) {
		$id = $arr['condition'];
		$r =$arr['data'];
		return DB::Update($n, $id, $r);
	}
	// tuyen nguyen start code
	static public function UpdateSaleOff($n, $id, $r=array()) {
		DB::UpdateSaleOffOrder($n, $id, $r);
		return Cache::Del(Cache::GetObjectKey($n,$id));
	}

	// tuyen nguyen end code

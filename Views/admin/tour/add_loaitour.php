...
<input name="loaitour_id"type="hidden" value="<?php echo $intro_id?>">
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	...
	<td>
		...
		<tr>
			<th valign="top">Tên Loại:</th>
			<td><input name="ten_loai"type="text" class="inp-form" value="<?php echo $intro['ten_dia_diem']?>"/></td>
			<td></td>
		</tr>

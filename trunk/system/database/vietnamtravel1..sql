...
--
-- Host: localhost
-- Generation Time: Mar 21, 2012 at 04:57 PM
...
--
-- Table structure for table `loai_diem_den`
--

CREATE TABLE IF NOT EXISTS `loai_diem_den` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `loai_diem_den`
--

INSERT INTO `loai_diem_den` (`ID`, `TEN_DIA_DIEM`) VALUES
(1, 'THÁI LAN'),
(2, 'LÀO'),
(3, 'CAMPUCHIA'),
(4, 'MỸ'),
...
--
-- Table structure for table `loai_ve_may_bay`
--

CREATE TABLE IF NOT EXISTS `loai_ve_may_bay` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `loai_ve_may_bay`
--

INSERT INTO `loai_ve_may_bay` (`ID`, `TEN_LOAI`) VALUES
(1, 'Khứ Hồi Trong Nước'),
(2, 'Một Chiều Trong Nước'),
(3, 'Khứ Hồi Quốc Tế'),
(4, 'Một Chiều Quốc Tế');

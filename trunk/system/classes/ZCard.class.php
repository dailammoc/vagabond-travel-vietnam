...
class ZCard
{
	...
	static public function Explain($errno) {
		switch($errno) {
			case self::ERR_NOCARD : return 'voucher does not exist';
			case self::ERR_TEAM : return 'voucher cannot used on this order';
			case self::ERR_CREDIT : return 'voucher credit is not enough';
			case self::ERR_EXPIRE : return 'voucher is expired';
			case self::ERR_USED : return 'voucher is used';
			case self::ERR_ORDER: return 'only 1 voucher can be used';
		}

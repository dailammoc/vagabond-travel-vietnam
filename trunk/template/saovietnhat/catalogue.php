...
<title>Công ty CP xuất nhập khẩu Sao Việt Nhật - danh mục sản phẩm - <?=$row1['TenLoai']?></title>
<meta name="description" content="sao việt nhật - Công ty CP xuất nhập khẩu sao việt nhật." />
<meta name="keywords" content="<?=$row1['TenLoai']?>, thiet ke in an, giay in hoa don ATM, giay in, thung carton, qua tang quang cao, bieu mau van phong, catalogue lich tet, hang qua tang, cong ty CP xuat nhap khau Sao Viet Nhat." />
    		...
    		<div id="main">
                ...
                <div class="right">
                	<?php 
						...
						else include "middle_catalogue.php";
					?>
                </div>
            </div>    	
    </div>
